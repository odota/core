module.exports = function buildMap() {
    ...
    const bits = [
        window.pad(Number($('#map').attr('data-tower-radiant')).toString(2), 11),
        window.pad(Number($('#map').attr('data-barracks-radiant')).toString(2), 6),
        window.pad(Number($('#map').attr('data-tower-dire')).toString(2), 11),
        window.pad(Number($('#map').attr('data-barracks-dire')).toString(2), 6),
        $('#map').attr('data-radiant-win') === '1' ? '10' : '01'
    ].join('');
