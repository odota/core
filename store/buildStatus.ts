...
import { getRedisCountDay, getRedisCountHour, parallelPromise } from '../util/utility';
...
export async function buildStatus() {
  const obj = {
    ...
    retriever_matches_last_day: async () => getRedisCountDay(redis, 'retriever'),
    retriever_players_last_day: async () => getRedisCountDay(redis, 'retriever_player'),
    ...
    match_archive_write_last_day: async () => getRedisCountDay(redis, 'match_archive_write'),
    incomplete_archive_last_day: async () => getRedisCountDay(redis, 'incomplete_archive'),
    ...
    scanner_exception_last_day: async () => getRedisCountDay(redis, 'scanner_exception'),
    seqNumDelay: async () => {
