...
export async function getMatchBlob(
  matchId: number,
  fetchers: { apiFetcher: MatchFetcher<ApiMatch>, gcFetcher: MatchFetcher<GcMatch>, parsedFetcher: MatchFetcher<ParserMatch>, archivedFetcher?: MatchFetcher<ParsedMatch> },
