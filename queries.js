...
function fillPlayerData(player, options, cb) {
    var selection = {
        ...
        "players.hero_id": options.req.query.hero_id
        //support querying on hero_id after account_id
        //post-process filter or elemmatch
        */
    };
    var projection = {
        "players.$": 1,
    ...
    if (options.info !== "matches") {
        ...
        //todo currently api/matches projects players to prevent advquery crash
