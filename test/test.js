...
describe("replay parse", function ()
{
    ...
    for (var key in tests)
    {
        it('parse replay ' + key, function (done)
        {
            ...
            {
                request('https://github.com/opendota/testfiles/raw/master/1781962623_1.dem',
                {
                    encoding: null
...
describe('api', function ()
{
    ...
    {
        request('https://raw.githubusercontent.com/opendota/api/gh-pages/openapi.json', function (err, resp, body)
        {
            if (err)
            {
                return cb(err);
