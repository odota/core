    ...
    public static void main(String[] args) throws Exception {
        ...
        System.exit(0);
                    ...
                    if (g.getEventId() == combatLogDescriptor.getEventId()) {
                        ...
                        switch(cle.getType()) {
                            ...
                            */
                            ...
                            case 12:
                            //buyback
                            entry.slot = String.valueOf(cle.getValue());
                            entry.key = "buyback";
                            entry.type = "buybacks";
                            log.add(entry);
                            break;
            ...
            for (int i =0;i<log.length();i++){
                ...
                if(entry.has("value")){
                    counts.put(key, count+entry.get(value));
                }
                else{
