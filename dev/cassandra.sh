...
sudo docker run --name cassandra --restart=always --log-opt max-size=1g -d --net=host -v /var/lib/cassandra:/var/lib/cassandra -e CASSANDRA_SEEDS=cassandra-1 cassandra:4
