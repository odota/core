...
var streamTypes = {
    ...
    {
        index_to_playerslot[e.key] = e.value;
    },
     "interval": function(e)
        {
...
{
    counts[e.type] = counts[e.type] ? counts[e.type] + 1 : 1;
    if (counts[e.type] === 1)
    {
        console.error(e)
    }
...
{
    //adjust time
    e.time = e.time - game_zero;
    //get player_slot
    //group rows by category into hash
    //regenerate new rows and append to output
