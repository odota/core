...
gcloud compute instance-templates delete --quiet retriever-8
gcloud compute instance-templates create retriever-8 --machine-type f1-micro --image-family ubuntu-1404-lts --image-project ubuntu-os-cloud --preemptible --boot-disk-size 10GB --boot-disk-type pd-standard --tags "http-server" --network=retriever --scopes default="https://www.googleapis.com/auth/compute" --metadata-from-file startup-script=./scripts/retriever.sh
