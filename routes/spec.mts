  ...
  paths: {
      ...
      get: {
        ...
        func: (req, res, cb) => {
          ...
          queries.getPlayerMatches(
            ...
            req.queryObj,
            (err: Error | null, cache: ParsedPlayerMatch[]) => {
              if (err) {
                return cb(err);
              }
              cache.forEach((m) => {
    ...
    '/metadata': {
      get: {
        ...
        route: () => '/metadata',
        func: (req, res, cb) => {
          queries.getMetadata(req, (err: Error | null, result: any) => {
            if (err) {
              return cb(err);
            }
            return res.json(result);
    ...
    '/scenarios/itemTimings': {
      get: {
        ...
        func: (req, res, cb) => {
          queries.getItemTimings(req, (err: Error | null, result: any) => {
            if (err) {
              return cb(err);
            }
            return res.json(result.rows);
    ...
    '/scenarios/laneRoles': {
      get: {
        ...
        func: (req, res, cb) => {
          queries.getLaneRoles(req, (err: Error | null, result: any) => {
            if (err) {
              return cb(err);
            }
            return res.json(result.rows);
    ...
    '/scenarios/misc': {
      get: {
        ...
        func: (req, res, cb) => {
          queries.getTeamScenarios(req, (err: Error | null, result: any) => {
            if (err) {
              return cb(err);
            }
            return res.json(result.rows);
