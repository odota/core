...
module.exports = function advQuery(select, options, cb) {
    ...
    //limit/skip are useful for datatables server-side ajax calls, but also prevent aggregation
...
Maybe we can add jQuery helpers to construct the query, use same advquery UI for:
